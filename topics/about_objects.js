...
test("adding functions", () => {
    const person = {
        ...
        age: 102,
        toString: function() {
            //return "I this;  // HINT: use the 'this' keyword to refer to the person object.
            return `I ${person.name} am ${person.age} years old.`;  // Usando templates de String que rescate de un curso.
        }
    };
